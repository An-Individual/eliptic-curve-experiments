...
{
    // Straight copied from https://gist.github.com/CodesInChaos/3175971
    public static class Base58Encoding
    {
        ...
        {
            byte[] result = data.Take(data.Length - CheckSumSizeInBytes).ToArray();
            byte[] givenCheckSum = data.Skip(data.Length - CheckSumSizeInBytes).ToArray();
